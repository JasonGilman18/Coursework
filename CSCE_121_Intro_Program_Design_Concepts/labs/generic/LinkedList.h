...
template <typename T>
LinkedList<T>::LinkedList(std::string name) : head(nullptr), tail(nullptr), name(name) {}
...
template <typename T>
void LinkedList<T>::set_name(std::string name)
{
    this->name = name;
}

template <typename T>
std::string LinkedList<T>::get_name() const
{
    return name;
}
...
template <typename T>
void LinkedList<T>::log(const std::string& what) const
{
